...
class web(base_module):
    def __init__(self, interpreter):
        ...
        self.dictionary = {
            ...
            'addattr' : '''local value local name local container name @ value @ container @ @ "attrs" cell@ cell+ drop''',
