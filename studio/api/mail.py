...
import traceback
from utils import *
import predefined_mails
import config_mails
import html


# data = { "lang" : "fr|en|...", "predname" : "passlost | signin", "email" : "emailtosend", "toreplace" : { "name" : "fred", "link" : "http://www.yahoo.fr" }}
data = get_post_data()
...
if not is_valid_email(emailtosend):
    ...
    if lang not in predefined_mails or predname not in predefined_mails.get(lang, {}):
        ...
        predemail = predefined_mails[lang][predname].copy()
